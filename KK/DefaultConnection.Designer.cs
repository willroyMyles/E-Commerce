...
namespace KK {
    ...
    public partial class DefaultConnection : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Id, string Name, int Price, int Quantity, System.DateTime Purchased, int Category, string Img, string Description, string Owner) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([Id], [Name], [Price], [Quantity], [Purchased], [Category" +
                "], [Img], [Description], [Owner]) VALUES (@Id, @Name, @Price, @Quantity, @Purcha" +
                "sed, @Category, @Img, @Description, @Owner)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Products] SET [Id] = @Id, [Name] = @Name, [Price] = @Price, [Quantity] = " +
                ...
                "ription] = @Description, [Owner] = @Owner WHERE (([Id] = @Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, Name, Price, Quantity, Purchased, Category, Img, Description, Owner\r\nF" +
                "ROM   Products\r\nWHERE (Owner = @owner)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@owner", global::System.Data.SqlDbType.NVarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "Owner", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id AS Expr1, Name AS Expr2, Price AS Expr3, Quantity AS Expr4, Purchased A" +
                "S Expr5, Category AS Expr6, Img AS Expr7, Description AS Expr8, Owner AS Expr9\r\n" +
                "FROM   Products\r\nWHERE (Id = @id)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id", global::System.Data.SqlDbType.NVarChar, 128, global::System.Data.ParameterDirection.Input, 0, 0, "Expr1", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Owner", global::System.Data.SqlDbType.NVarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "Owner", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        public virtual int Fill(DefaultConnection.ProductsDataTable dataTable) {
        ...
        public virtual int Insert(string Id, string Name, int Price, int Quantity, System.DateTime Purchased, int Category, string Img, string Description, string Owner) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        public virtual int Update(string Id, string Name, int Price, int Quantity, System.DateTime Purchased, int Category, string Img, string Description, string Owner, string Original_Id) {
            if ((Id == null)) {
                throw new global::System.ArgumentNullException("Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Price, int Quantity, System.DateTime Purchased, int Category, string Img, string Description, string Owner, string Original_Id) {
            return this.Update(Original_Id, Name, Price, Quantity, Purchased, Category, Img, Description, Owner, Original_Id);
        }
